...
st.title("硬件方案")
st.sidebar.title("硬件方案")
st.sidebar.write("1.GPU方案")
st.sidebar.write("2.CPU方案")
st.sidebar.write("3.移动设备和嵌入式设备")
st.write("1.GPU方案")
...
st.write("3.移动设备和嵌入式设备")
st.write("移动设备和嵌入式设备主要使用较小的端侧模型，不过可以选择优先内存较大的版本以部署phi4等性能较高的模型。")